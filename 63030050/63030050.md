## 63030050 ปราโมทย์ จอนสูงเนิน

*ข้อที่ 1 วิ่งไปสุดปลายทางแล้ววิ่งกลับ (ping-pong)*

https://youtube.com/shorts/X4TTmx5jjsU?feature=share
```c
    #include <stdio.h>
    #include <stdbool.h>
    #include <unistd.h>
