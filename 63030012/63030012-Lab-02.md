## 63030012 นาย เจษฎา ศรศรี

*ข้อที่ 1 วิ่งไปสุดปลายทางแล้ววิ่งกลับ (ping-pong)*

https://drive.google.com/file/d/1p3dGUtDPUTPbTHt2OhJCTpVGsEtVtSXp/view?usp=sharing
```c
    #include <stdio.h>
    #include <stdbool.h>
    #include <unistd.h>
...
https://drive.google.com/file/d/1nlQ0dN6ZUk-fGMP30hB8E0lYocEHh9um/view?usp=sharing
```c
    #include <stdio.h>
    #include <stdbool.h>
    #include <unistd.h>
...
https://drive.google.com/file/d/1ZCreU-WUTHWDBUd8PoCLzIFfphrWeiEG/view?usp=sharing
```c
    #include <stdio.h>
    #include <stdbool.h>
    #include <unistd.h>
...
https://drive.google.com/file/d/1TrL7PMFpTNhfSLJCQ5iTwsu_CH6Lhuf7/view?usp=sharing
```c
    #include <stdio.h>
    #include <stdbool.h>
    #include <unistd.h>
