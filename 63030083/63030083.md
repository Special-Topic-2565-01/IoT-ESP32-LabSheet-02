## 63030083 Supanut Pattawaro

*ข้อที่ 1 วิ่งไปสุดปลายทางแล้ววิ่งกลับ (ping-pong)*

https://youtube.com/shorts/UAv_WTNBnXs?feature=share
```c
    #include <stdio.h>
    #include <stdbool.h>
    #include <unistd.h>
...
https://youtube.com/shorts/8kOzVslvQN4?feature=share
```c
    #include <stdio.h>
    #include <stdbool.h>
    #include <unistd.h>
...
https://youtube.com/shorts/gifonPs7Ycs?feature=share
```c
    #include <stdio.h>
    #include <stdbool.h>
    #include <unistd.h>
